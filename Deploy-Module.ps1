...
$itemsToDeploy = @("LICENSE","TestDatabase.kdbx","KeePassLib.dll","PowerPass\PowerPass.ps1","PowerPass\PowerPass.psd1","PowerPass\PowerPass.psm1",".\PowerPass\StatusLogger.cs")
