...
namespace Tpm2Lib
{
    ...
    public class PRNG
    {
        ...
        /// MODIFIED: PowerPass. Warning SYSLIB0023: Converted to RandomNumberGenerator.
        /// </summary>
        private static readonly RandomNumberGenerator CryptoRand = RandomNumberGenerator.Create();
